...
class DistanceMatrixResponseRow extends jsw.TypedProxy {
  static DistanceMatrixResponseRow cast(js.Proxy proxy) => proxy == null ? null : new DistanceMatrixResponseRow.fromProxy(proxy);
