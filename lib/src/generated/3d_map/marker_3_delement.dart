...
@JS('google.maps.maps3d.Marker3DElement')
extension type Marker3DElement._(HTMLElement _)
    implements HTMLElement, Marker3DElementOptions {
  external Marker3DElement([
