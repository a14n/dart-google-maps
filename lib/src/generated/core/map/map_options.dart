...
dynamic/*MapTypeId|string*/ get mapTypeId {
  ...
  void set mapTypeId(dynamic mapTypeId) { $unsafe['mapTypeId'] = mapTypeId; }
...
set styles(List<MapTypeStyle> styles) => $unsafe['styles'] = styles == null ? null : styles is js.Serializable<js.JsObject> ? styles : js.jsify(styles);
