...
set steps(List<DirectionsStep> steps) => $unsafe['steps'] = steps == null ? null : steps is js.Serializable<js.JsObject> ? steps : js.jsify(steps);
List<DirectionsStep> get steps => jsw.TypedJsArray.castListOfSerializables($unsafe['steps'], DirectionsStep.cast);
set viaWaypoints(List<LatLng> viaWaypoints) => $unsafe['via_waypoints'] = viaWaypoints == null ? null : viaWaypoints is js.Serializable<js.JsObject> ? viaWaypoints : js.jsify(viaWaypoints);
