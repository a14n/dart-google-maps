...
class Spherical {
  static num computeArea(Object /*List<LatLng>|MVCArray<LatLng>*/ path,
          [num radius]) =>
      callMethod(_Spherical$namespace, 'computeArea', [path, radius]);
  static num computeDistanceBetween(LatLng from, LatLng to, [num radius]) =>
      callMethod(
  ...
  static num computeLength(Object /*List<LatLng>|MVCArray<LatLng>*/ path,
          [num radius]) =>
  ...
  static num computeSignedArea(Object /*List<LatLng>|MVCArray<LatLng>*/ loop,
          [num radius]) =>
