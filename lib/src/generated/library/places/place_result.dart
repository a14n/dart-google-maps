...
set photos(List<PlacePhoto> photos) => $unsafe['photos'] = photos == null ? null : photos is js.Serializable<js.JsObject> ? photos : js.jsify(photos);
...
set reviews(List<PlaceReview> reviews) => $unsafe['reviews'] = reviews == null ? null : reviews is js.Serializable<js.JsObject> ? reviews : js.jsify(reviews);
