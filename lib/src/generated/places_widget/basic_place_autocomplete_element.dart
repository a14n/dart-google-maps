...
@JS('google.maps.places.BasicPlaceAutocompleteElement')
extension type BasicPlaceAutocompleteElement._(HTMLElement _)
    implements HTMLElement, BasicPlaceAutocompleteElementOptions {
  external BasicPlaceAutocompleteElement(
    BasicPlaceAutocompleteElementOptions options,
  );
