...
@JS('google.maps.places.PlaceNearbySearchRequestElement')
extension type PlaceNearbySearchRequestElement._(HTMLElement _)
    implements HTMLElement, PlaceNearbySearchRequestElementOptions {
  external PlaceNearbySearchRequestElement([
    PlaceNearbySearchRequestElementOptions? options,
  ]);
