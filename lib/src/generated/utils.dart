...
js.Serializable<js.JsObject> jsifyList(List list) => (list is js.Serializable<js.JsObject>) ? list : js.jsify(list);
js.Serializable<js.JsObject> jsifyDateTime(DateTime dateTime) => (dateTime is js.Serializable<js.JsObject>) ? (dateTime as js.Serializable<js.JsObject>) : new jsw.JsDateToDateTimeAdapter(dateTime);
