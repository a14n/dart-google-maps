...
class DrawingManager extends MVCObject implements _DrawingManager {
  ...
  DrawingManager([DrawingManagerOptions options]) : this.created(new JsObject(
          ...
          [__codec161.encode(options)]));

  OverlayType get drawingMode => _getDrawingMode();
  OverlayType _getDrawingMode() =>
      __codec162.decode(asJsObject(this).callMethod('getDrawingMode'));
  ...
  void _setDrawingMode(OverlayType drawingMode) {
    asJsObject(this).callMethod(
        'setDrawingMode', [__codec162.encode(drawingMode)]);
  }
  ...
  void _setOptions(DrawingManagerOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec161.encode(options)]);
  }
...
final __codec161 = new JsInterfaceCodec<DrawingManagerOptions>(
...
class DrawingManagerOptions extends JsInterface
  ...
  void set circleOptions(CircleOptions _circleOptions) {
    asJsObject(this)['circleOptions'] = __codec164.encode(_circleOptions);
  }
  CircleOptions get circleOptions =>
      __codec164.decode(asJsObject(this)['circleOptions']);
  ...
  void set drawingControlOptions(DrawingControlOptions _drawingControlOptions) {
    asJsObject(this)['drawingControlOptions'] =
        __codec165.encode(_drawingControlOptions);
  }
  DrawingControlOptions get drawingControlOptions =>
      __codec165.decode(asJsObject(this)['drawingControlOptions']);
  void set drawingMode(OverlayType _drawingMode) {
    asJsObject(this)['drawingMode'] = __codec162.encode(_drawingMode);
  }
  OverlayType get drawingMode =>
      __codec162.decode(asJsObject(this)['drawingMode']);
  ...
  void set markerOptions(MarkerOptions _markerOptions) {
    asJsObject(this)['markerOptions'] = __codec166.encode(_markerOptions);
  }
  MarkerOptions get markerOptions =>
      __codec166.decode(asJsObject(this)['markerOptions']);
  void set polygonOptions(PolygonOptions _polygonOptions) {
    asJsObject(this)['polygonOptions'] = __codec167.encode(_polygonOptions);
  }
  PolygonOptions get polygonOptions =>
      __codec167.decode(asJsObject(this)['polygonOptions']);
  void set polylineOptions(PolylineOptions _polylineOptions) {
    asJsObject(this)['polylineOptions'] = __codec168.encode(_polylineOptions);
  }
  PolylineOptions get polylineOptions =>
      __codec168.decode(asJsObject(this)['polylineOptions']);
  void set rectangleOptions(RectangleOptions _rectangleOptions) {
    asJsObject(this)['rectangleOptions'] = __codec169.encode(_rectangleOptions);
  }
  RectangleOptions get rectangleOptions =>
      __codec169.decode(asJsObject(this)['rectangleOptions']);
}
...
final __codec165 = new JsInterfaceCodec<DrawingControlOptions>(
...
final __codec168 = new JsInterfaceCodec<PolylineOptions>(
    (o) => new PolylineOptions.created(o));

/// codec for RectangleOptions
final __codec169 = new JsInterfaceCodec<RectangleOptions>(
...
class DrawingControlOptions extends JsInterface
  ...
  void set drawingModes(List<OverlayType> _drawingModes) {
    asJsObject(this)['drawingModes'] = __codec170.encode(_drawingModes);
  }
  List<OverlayType> get drawingModes =>
      __codec170.decode(asJsObject(this)['drawingModes']);
  void set position(ControlPosition _position) {
    asJsObject(this)['position'] = __codec171.encode(_position);
  }
  ControlPosition get position =>
      __codec171.decode(asJsObject(this)['position']);
}
