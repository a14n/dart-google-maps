...
class Autocomplete extends MVCObject implements _Autocomplete {
  ...
  Autocomplete(InputElement inputField, [AutocompleteOptions opts])
      : this.created(new JsObject(getPath('google.maps.places.Autocomplete'), [
        inputField,
        __codec183.encode(opts)
      ]));

  LatLngBounds get bounds => _getBounds();
  LatLngBounds _getBounds() =>
      __codec184.decode(asJsObject(this).callMethod('getBounds'));
  PlaceResult get place => _getPlace();
  PlaceResult _getPlace() =>
      __codec185.decode(asJsObject(this).callMethod('getPlace'));
  void set bounds(LatLngBounds bounds) => _setBounds(bounds);
  void _setBounds(LatLngBounds bounds) {
    asJsObject(this).callMethod('setBounds', [__codec184.encode(bounds)]);
  }
  ...
  void _setComponentRestrictions(ComponentRestrictions restrictions) {
    asJsObject(this).callMethod(
        'setComponentRestrictions', [__codec186.encode(restrictions)]);
  }
  void set types(List<String> types) => _setTypes(types);
  void _setTypes(List<String> types) {
    asJsObject(this).callMethod('setTypes', [__codec187.encode(types)]);
  }
...
final __codec183 = new JsInterfaceCodec<AutocompleteOptions>(
...
final __codec186 = new JsInterfaceCodec<ComponentRestrictions>(
    (o) => new ComponentRestrictions.created(o));

/// codec for List<String>
final __codec187 = new JsListCodec<String>(null);
...
class AutocompleteOptions extends JsInterface implements _AutocompleteOptions {
  ...
  void set bounds(LatLngBounds _bounds) {
    asJsObject(this)['bounds'] = __codec184.encode(_bounds);
  }
  LatLngBounds get bounds => __codec184.decode(asJsObject(this)['bounds']);
  void set componentRestrictions(ComponentRestrictions _componentRestrictions) {
    asJsObject(this)['componentRestrictions'] =
        __codec186.encode(_componentRestrictions);
  }
  ComponentRestrictions get componentRestrictions =>
      __codec186.decode(asJsObject(this)['componentRestrictions']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec187.encode(_types);
  }
  List<String> get types => __codec187.decode(asJsObject(this)['types']);
}
...
class AutocompletePrediction extends JsInterface
  ...
  void set _matched_substrings(List<PredictionSubstring> __matched_substrings) {
    asJsObject(this)['matched_substrings'] =
        __codec189.encode(__matched_substrings);
  }
  List<PredictionSubstring> get _matched_substrings =>
      __codec189.decode(asJsObject(this)['matched_substrings']);
  ...
  void set terms(List<PredictionTerm> _terms) {
    asJsObject(this)['terms'] = __codec191.encode(_terms);
  }
  List<PredictionTerm> get terms =>
      __codec191.decode(asJsObject(this)['terms']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec187.encode(_types);
  }
  List<String> get types => __codec187.decode(asJsObject(this)['types']);
...
final __codec188 = new JsInterfaceCodec<PredictionSubstring>(
    (o) => new PredictionSubstring.created(o));

/// codec for List<PredictionSubstring>
final __codec189 = new JsListCodec<PredictionSubstring>(__codec188);
...
final __codec191 = new JsListCodec<PredictionTerm>(__codec190);
...
class AutocompleteService extends JsInterface implements _AutocompleteService {
  ...
  void getPlacePredictions(AutocompletionRequest request,
    ...
    asJsObject(this).callMethod('getPlacePredictions', [
      __codec192.encode(request),
      __codec197.encode(callback)
    ]);
  }
  void getQueryPredictions(QueryAutocompletionRequest request,
    ...
    asJsObject(this).callMethod('getQueryPredictions', [
      __codec198.encode(request),
      __codec201.encode(callback)
    ]);
  }
}
/// codec for AutocompletionRequest
final __codec192 = new JsInterfaceCodec<AutocompletionRequest>(
    (o) => new AutocompletionRequest.created(o));

/// codec for dynamic
final __codec193 = new DynamicCodec();

/// codec for AutocompletePrediction
final __codec194 = new JsInterfaceCodec<AutocompletePrediction>(
    (o) => new AutocompletePrediction.created(o));

/// codec for List<AutocompletePrediction>
final __codec195 = new JsListCodec<AutocompletePrediction>(__codec194);

/// codec for PlacesServiceStatus
final __codec196 = new BiMapCodec<PlacesServiceStatus, dynamic>(
...
final __codec197 =
    new FunctionCodec /*<(List<AutocompletePrediction>, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec195.decode(p_p1);
  p_p2 = __codec196.decode(p_p2);
  final result = f(p_p1, p_p2);
  return __codec193.encode(result);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec195.encode(p_p1);
  p_p2 = __codec196.encode(p_p2);
  final result = f.apply([p_p1, p_p2]);
  return __codec193.decode(result);
});

/// codec for QueryAutocompletionRequest
final __codec198 = new JsInterfaceCodec<QueryAutocompletionRequest>(
    (o) => new QueryAutocompletionRequest.created(o));

/// codec for QueryAutocompletePrediction
final __codec199 = new JsInterfaceCodec<QueryAutocompletePrediction>(
    (o) => new QueryAutocompletePrediction.created(o));

/// codec for List<QueryAutocompletePrediction>
final __codec200 = new JsListCodec<QueryAutocompletePrediction>(__codec199);
...
final __codec201 =
    new FunctionCodec /*<(List<QueryAutocompletePrediction>, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec200.decode(p_p1);
  p_p2 = __codec196.decode(p_p2);
  final result = f(p_p1, p_p2);
  return __codec193.encode(result);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec200.encode(p_p1);
  p_p2 = __codec196.encode(p_p2);
  final result = f.apply([p_p1, p_p2]);
  return __codec193.decode(result);
});
...
class AutocompletionRequest extends JsInterface
  ...
  void set location(LatLng _location) {
    asJsObject(this)['location'] = __codec202.encode(_location);
  }
  LatLng get location => __codec202.decode(asJsObject(this)['location']);
  void set offset(num _offset) {
    asJsObject(this)['offset'] = _offset;
  }
  num get offset => asJsObject(this)['offset'];
...
/// codec for LatLng
final __codec202 = new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o));
...
class PlaceGeometry extends JsInterface implements _PlaceGeometry {
  ...
  void set viewport(LatLngBounds _viewport) {
    asJsObject(this)['viewport'] = __codec184.encode(_viewport);
  }
  LatLngBounds get viewport => __codec184.decode(asJsObject(this)['viewport']);
}
...
class PlacePhoto extends JsInterface implements _PlacePhoto {
  ...
  String getUrl(PhotoOptions opts) =>
      asJsObject(this).callMethod('getUrl', [__codec203.encode(opts)]);
  ...
  void set _html_attributions(List<String> __html_attributions) {
    asJsObject(this)['html_attributions'] =
        __codec187.encode(__html_attributions);
  }
  List<String> get _html_attributions =>
      __codec187.decode(asJsObject(this)['html_attributions']);
...
class PlaceResult extends JsInterface implements _PlaceResult {
  ...
  void set _address_components(
    ...
    asJsObject(this)['address_components'] =
        __codec205.encode(__address_components);
  }
  List<GeocoderAddressComponent> get _address_components =>
      __codec205.decode(asJsObject(this)['address_components']);
  ...
  void set aspects(List<PlaceAspectRating> _aspects) {
    asJsObject(this)['aspects'] = __codec207.encode(_aspects);
  }
  List<PlaceAspectRating> get aspects =>
      __codec207.decode(asJsObject(this)['aspects']);
  ...
  void set geometry(PlaceGeometry _geometry) {
    asJsObject(this)['geometry'] = __codec208.encode(_geometry);
  }
  PlaceGeometry get geometry => __codec208.decode(asJsObject(this)['geometry']);
  void set _html_attributions(List<String> __html_attributions) {
    asJsObject(this)['html_attributions'] =
        __codec187.encode(__html_attributions);
  }
  ...
  void set photos(List<PlacePhoto> _photos) {
    asJsObject(this)['photos'] = __codec210.encode(_photos);
  }
  List<PlacePhoto> get photos => __codec210.decode(asJsObject(this)['photos']);
  void set _place_id(String __place_id) {
    asJsObject(this)['place_id'] = __place_id;
  }
  String get _place_id => asJsObject(this)['place_id'];
  ...
  void set reviews(List<PlaceReview> _reviews) {
    asJsObject(this)['reviews'] = __codec212.encode(_reviews);
  }
  List<PlaceReview> get reviews =>
      __codec212.decode(asJsObject(this)['reviews']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec187.encode(_types);
  }
  List<String> get types => __codec187.decode(asJsObject(this)['types']);
...
final __codec204 = new JsInterfaceCodec<GeocoderAddressComponent>(
    (o) => new GeocoderAddressComponent.created(o));

/// codec for List<GeocoderAddressComponent>
final __codec205 = new JsListCodec<GeocoderAddressComponent>(__codec204);

/// codec for PlaceAspectRating
final __codec206 = new JsInterfaceCodec<PlaceAspectRating>(
    (o) => new PlaceAspectRating.created(o));

/// codec for List<PlaceAspectRating>
final __codec207 = new JsListCodec<PlaceAspectRating>(__codec206);
...
final __codec210 = new JsListCodec<PlacePhoto>(__codec209);
...
final __codec212 = new JsListCodec<PlaceReview>(__codec211);
...
class PlaceSearchRequest extends JsInterface implements _PlaceSearchRequest {
  ...
  void set rankBy(RankBy _rankBy) {
    asJsObject(this)['rankBy'] = __codec213.encode(_rankBy);
  }
  RankBy get rankBy => __codec213.decode(asJsObject(this)['rankBy']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec187.encode(_types);
  }
  List<String> get types => __codec187.decode(asJsObject(this)['types']);
...
/// codec for RankBy
final __codec213 = new BiMapCodec<RankBy, dynamic>(
...
class PlacesService extends JsInterface implements _PlacesService {
  ...
  PlacesService(dynamic /*HTMLDivElement|GMap*/ attrContainer) : this.created(
          new JsObject(getPath('google.maps.places.PlacesService'),
              [__codec193.encode(attrContainer)]));
  ...
  void getDetails(PlaceDetailsRequest request,
    ...
    asJsObject(this).callMethod('getDetails', [
      __codec214.encode(request),
      __codec215.encode(callback)
    ]);
  }
...
final __codec214 = new JsInterfaceCodec<PlaceDetailsRequest>(
...
final __codec215 =
    new FunctionCodec /*<(PlaceResult, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec185.decode(p_p1);
  p_p2 = __codec196.decode(p_p2);
  final result = f(p_p1, p_p2);
  return __codec193.encode(result);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec185.encode(p_p1);
  p_p2 = __codec196.encode(p_p2);
  final result = f.apply([p_p1, p_p2]);
  return __codec193.decode(result);
});
...
final __codec216 = new JsInterfaceCodec<PlaceSearchRequest>(
    (o) => new PlaceSearchRequest.created(o));

/// codec for List<PlaceResult>
final __codec217 = new JsListCodec<PlaceResult>(__codec185);

/// codec for PlaceSearchPagination
final __codec218 = new JsInterfaceCodec<PlaceSearchPagination>(
...
final __codec219 =
    new FunctionCodec /*<(List<PlaceResult>, PlacesServiceStatus, PlaceSearchPagination) → dynamic>*/ (
        (f) => (p_p1, p_p2, p_p3) {
  p_p1 = __codec217.decode(p_p1);
  p_p2 = __codec196.decode(p_p2);
  p_p3 = __codec218.decode(p_p3);
  final result = f(p_p1, p_p2, p_p3);
  return __codec193.encode(result);
}, (JsFunction f) => (p_p1, p_p2, p_p3) {
  p_p1 = __codec217.encode(p_p1);
  p_p2 = __codec196.encode(p_p2);
  p_p3 = __codec218.encode(p_p3);
  final result = f.apply([p_p1, p_p2, p_p3]);
  return __codec193.decode(result);
});

/// codec for RadarSearchRequest
final __codec220 = new JsInterfaceCodec<RadarSearchRequest>(
...
class SearchBox extends MVCObject implements _SearchBox {
  ...
  List<PlaceResult> _getPlaces() =>
      __codec217.decode(asJsObject(this).callMethod('getPlaces'));
  void set bounds(LatLngBounds bounds) => _setBounds(bounds);
  void _setBounds(LatLngBounds bounds) {
    asJsObject(this).callMethod('setBounds', [__codec184.encode(bounds)]);
  }
...
final __codec224 = new JsInterfaceCodec<SearchBoxOptions>(
