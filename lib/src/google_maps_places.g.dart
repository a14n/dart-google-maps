...
class Autocomplete extends MVCObject implements _Autocomplete {
  ...
  LatLngBounds _getBounds() =>
      __codec181.decode(asJsObject(this).callMethod('getBounds'));
  PlaceResult get place => _getPlace();
  PlaceResult _getPlace() =>
      __codec182.decode(asJsObject(this).callMethod('getPlace'));
  void set bounds(LatLngBounds bounds) => _setBounds(bounds);
  void _setBounds(LatLngBounds bounds) {
    asJsObject(this).callMethod('setBounds', [__codec181.encode(bounds)]);
  }
  ...
  void _setComponentRestrictions(ComponentRestrictions restrictions) {
    asJsObject(this).callMethod(
        'setComponentRestrictions', [__codec183.encode(restrictions)]);
  }
  void set types(List<String> types) => _setTypes(types);
  void _setTypes(List<String> types) {
    asJsObject(this).callMethod('setTypes', [__codec184.encode(types)]);
  }
...
final __codec180 = new JsInterfaceCodec<AutocompleteOptions>(
...
final __codec183 = new JsInterfaceCodec<ComponentRestrictions>(
    (o) => new ComponentRestrictions.created(o));

/// codec for List<String>
final __codec184 = new JsListCodec<String>(null);
...
class AutocompleteOptions extends JsInterface implements _AutocompleteOptions {
  ...
  void set bounds(LatLngBounds _bounds) {
    asJsObject(this)['bounds'] = __codec181.encode(_bounds);
  }
  LatLngBounds get bounds => __codec181.decode(asJsObject(this)['bounds']);
  void set componentRestrictions(ComponentRestrictions _componentRestrictions) {
    asJsObject(this)['componentRestrictions'] =
        __codec183.encode(_componentRestrictions);
  }
  ComponentRestrictions get componentRestrictions =>
      __codec183.decode(asJsObject(this)['componentRestrictions']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec184.encode(_types);
  }
  List<String> get types => __codec184.decode(asJsObject(this)['types']);
}
...
class AutocompletePrediction extends JsInterface
  ...
  void set _matched_substrings(List<PredictionSubstring> __matched_substrings) {
    asJsObject(this)['matched_substrings'] =
        __codec186.encode(__matched_substrings);
  }
  List<PredictionSubstring> get _matched_substrings =>
      __codec186.decode(asJsObject(this)['matched_substrings']);
  ...
  void set terms(List<PredictionTerm> _terms) {
    asJsObject(this)['terms'] = __codec188.encode(_terms);
  }
  List<PredictionTerm> get terms =>
      __codec188.decode(asJsObject(this)['terms']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec184.encode(_types);
  }
  List<String> get types => __codec184.decode(asJsObject(this)['types']);
...
final __codec185 = new JsInterfaceCodec<PredictionSubstring>(
    (o) => new PredictionSubstring.created(o));

/// codec for List<PredictionSubstring>
final __codec186 = new JsListCodec<PredictionSubstring>(__codec185);
...
final __codec188 = new JsListCodec<PredictionTerm>(__codec187);
...
class AutocompleteService extends JsInterface implements _AutocompleteService {
  ...
  void getPlacePredictions(AutocompletionRequest request,
    ...
    asJsObject(this).callMethod('getPlacePredictions', [
      __codec189.encode(request),
      __codec193.encode(callback)
    ]);
  }
...
final __codec189 = new JsInterfaceCodec<AutocompletionRequest>(
    (o) => new AutocompletionRequest.created(o));

/// codec for AutocompletePrediction
final __codec190 = new JsInterfaceCodec<AutocompletePrediction>(
    (o) => new AutocompletePrediction.created(o));

/// codec for List<AutocompletePrediction>
final __codec191 = new JsListCodec<AutocompletePrediction>(__codec190);

/// codec for PlacesServiceStatus
final __codec192 = new BiMapCodec<PlacesServiceStatus, dynamic>({
...
final __codec193 =
    new FunctionCodec /*<(List<AutocompletePrediction>, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec191.decode(p_p1);
  p_p2 = __codec192.decode(p_p2);
  return f(p_p1, p_p2);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec191.encode(p_p1);
  p_p2 = __codec192.encode(p_p2);
  return f.apply([p_p1, p_p2]);
});

/// codec for QueryAutocompletionRequest
final __codec194 = new JsInterfaceCodec<QueryAutocompletionRequest>(
    (o) => new QueryAutocompletionRequest.created(o));

/// codec for QueryAutocompletePrediction
final __codec195 = new JsInterfaceCodec<QueryAutocompletePrediction>(
    (o) => new QueryAutocompletePrediction.created(o));

/// codec for List<QueryAutocompletePrediction>
final __codec196 = new JsListCodec<QueryAutocompletePrediction>(__codec195);
...
final __codec197 =
    new FunctionCodec /*<(List<QueryAutocompletePrediction>, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec196.decode(p_p1);
  p_p2 = __codec192.decode(p_p2);
  return f(p_p1, p_p2);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec196.encode(p_p1);
  p_p2 = __codec192.encode(p_p2);
  return f.apply([p_p1, p_p2]);
});
...
class AutocompletionRequest extends JsInterface
  ...
  void set location(LatLng _location) {
    asJsObject(this)['location'] = __codec198.encode(_location);
  }
  LatLng get location => __codec198.decode(asJsObject(this)['location']);
  void set offset(num _offset) {
    asJsObject(this)['offset'] = _offset;
  }
  num get offset => asJsObject(this)['offset'];
...
/// codec for LatLng
final __codec198 = new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o));
...
class PlaceGeometry extends JsInterface implements _PlaceGeometry {
  ...
  void set viewport(LatLngBounds _viewport) {
    asJsObject(this)['viewport'] = __codec181.encode(_viewport);
  }
  LatLngBounds get viewport => __codec181.decode(asJsObject(this)['viewport']);
}
...
class PlacePhoto extends JsInterface implements _PlacePhoto {
  ...
  String getUrl(PhotoOptions opts) =>
      asJsObject(this).callMethod('getUrl', [__codec199.encode(opts)]);
  ...
  void set _html_attributions(List<String> __html_attributions) {
    asJsObject(this)['html_attributions'] =
        __codec184.encode(__html_attributions);
  }
  List<String> get _html_attributions =>
      __codec184.decode(asJsObject(this)['html_attributions']);
...
class PlaceResult extends JsInterface implements _PlaceResult {
  ...
  void set _address_components(
    ...
    asJsObject(this)['address_components'] =
        __codec201.encode(__address_components);
  }
  List<GeocoderAddressComponent> get _address_components =>
      __codec201.decode(asJsObject(this)['address_components']);
  ...
  void set aspects(List<PlaceAspectRating> _aspects) {
    asJsObject(this)['aspects'] = __codec203.encode(_aspects);
  }
  List<PlaceAspectRating> get aspects =>
      __codec203.decode(asJsObject(this)['aspects']);
  ...
  void set geometry(PlaceGeometry _geometry) {
    asJsObject(this)['geometry'] = __codec204.encode(_geometry);
  }
  PlaceGeometry get geometry => __codec204.decode(asJsObject(this)['geometry']);
  void set _html_attributions(List<String> __html_attributions) {
    asJsObject(this)['html_attributions'] =
        __codec184.encode(__html_attributions);
  }
  ...
  void set photos(List<PlacePhoto> _photos) {
    asJsObject(this)['photos'] = __codec206.encode(_photos);
  }
  List<PlacePhoto> get photos => __codec206.decode(asJsObject(this)['photos']);
  void set _place_id(String __place_id) {
    asJsObject(this)['place_id'] = __place_id;
  }
  String get _place_id => asJsObject(this)['place_id'];
  ...
  void set reviews(List<PlaceReview> _reviews) {
    asJsObject(this)['reviews'] = __codec208.encode(_reviews);
  }
  List<PlaceReview> get reviews =>
      __codec208.decode(asJsObject(this)['reviews']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec184.encode(_types);
  }
  List<String> get types => __codec184.decode(asJsObject(this)['types']);
...
final __codec200 = new JsInterfaceCodec<GeocoderAddressComponent>(
    (o) => new GeocoderAddressComponent.created(o));

/// codec for List<GeocoderAddressComponent>
final __codec201 = new JsListCodec<GeocoderAddressComponent>(__codec200);

/// codec for PlaceAspectRating
final __codec202 = new JsInterfaceCodec<PlaceAspectRating>(
    (o) => new PlaceAspectRating.created(o));

/// codec for List<PlaceAspectRating>
final __codec203 = new JsListCodec<PlaceAspectRating>(__codec202);
...
final __codec206 = new JsListCodec<PlacePhoto>(__codec205);
...
final __codec208 = new JsListCodec<PlaceReview>(__codec207);
...
class PlaceSearchRequest extends JsInterface implements _PlaceSearchRequest {
  ...
  void set rankBy(RankBy _rankBy) {
    asJsObject(this)['rankBy'] = __codec209.encode(_rankBy);
  }
  RankBy get rankBy => __codec209.decode(asJsObject(this)['rankBy']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec184.encode(_types);
  }
  List<String> get types => __codec184.decode(asJsObject(this)['types']);
...
/// codec for RankBy
final __codec209 = new BiMapCodec<RankBy, dynamic>({
  RankBy.DISTANCE: getPath('google.maps.places.RankBy')['DISTANCE'],
  RankBy.PROMINENCE: getPath('google.maps.places.RankBy')['PROMINENCE']
});
...
class PlacesService extends JsInterface implements _PlacesService {
  ...
  PlacesService(dynamic /*HTMLDivElement|GMap*/ attrContainer) : this.created(
          new JsObject(
              getPath('google.maps.places.PlacesService'), [attrContainer]));
  ...
  void getDetails(PlaceDetailsRequest request,
    ...
    asJsObject(this).callMethod('getDetails', [
      __codec210.encode(request),
      __codec211.encode(callback)
    ]);
  }
...
final __codec210 = new JsInterfaceCodec<PlaceDetailsRequest>(
...
final __codec211 =
    new FunctionCodec /*<(PlaceResult, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec182.decode(p_p1);
  p_p2 = __codec192.decode(p_p2);
  return f(p_p1, p_p2);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec182.encode(p_p1);
  p_p2 = __codec192.encode(p_p2);
  return f.apply([p_p1, p_p2]);
});

/// codec for PlaceSearchRequest
final __codec212 = new JsInterfaceCodec<PlaceSearchRequest>(
    (o) => new PlaceSearchRequest.created(o));

/// codec for List<PlaceResult>
final __codec213 = new JsListCodec<PlaceResult>(__codec182);

/// codec for PlaceSearchPagination
final __codec214 = new JsInterfaceCodec<PlaceSearchPagination>(
...
final __codec215 =
    new FunctionCodec /*<(List<PlaceResult>, PlacesServiceStatus, PlaceSearchPagination) → dynamic>*/ (
        (f) => (p_p1, p_p2, p_p3) {
  p_p1 = __codec213.decode(p_p1);
  p_p2 = __codec192.decode(p_p2);
  p_p3 = __codec214.decode(p_p3);
  return f(p_p1, p_p2, p_p3);
}, (JsFunction f) => (p_p1, p_p2, p_p3) {
  p_p1 = __codec213.encode(p_p1);
  p_p2 = __codec192.encode(p_p2);
  p_p3 = __codec214.encode(p_p3);
  return f.apply([p_p1, p_p2, p_p3]);
});

/// codec for RadarSearchRequest
final __codec216 = new JsInterfaceCodec<RadarSearchRequest>(
...
final __codec218 = new JsInterfaceCodec<TextSearchRequest>(
...
class SearchBox extends MVCObject implements _SearchBox {
  ...
  List<PlaceResult> _getPlaces() =>
      __codec213.decode(asJsObject(this).callMethod('getPlaces'));
  void set bounds(LatLngBounds bounds) => _setBounds(bounds);
  void _setBounds(LatLngBounds bounds) {
    asJsObject(this).callMethod('setBounds', [__codec181.encode(bounds)]);
  }
...
final __codec219 = new JsInterfaceCodec<SearchBoxOptions>(
