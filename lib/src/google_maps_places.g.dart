...
final __codec192 = new JsInterfaceCodec<AutocompletePrediction>(
    (o) => new AutocompletePrediction.created(o));

/// codec for List<AutocompletePrediction>
final __codec193 = new JsListCodec<AutocompletePrediction>(__codec192);

/// codec for PlacesServiceStatus
final __codec194 = new BiMapCodec<PlacesServiceStatus, dynamic>({
...
final __codec195 =
    new FunctionCodec /*<(List<AutocompletePrediction>, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec193.decode(p_p1);
  p_p2 = __codec194.decode(p_p2);
  return f(p_p1, p_p2);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec193.encode(p_p1);
  p_p2 = __codec194.encode(p_p2);
  return f.apply([p_p1, p_p2]);
});

/// codec for QueryAutocompletionRequest
final __codec196 = new JsInterfaceCodec<QueryAutocompletionRequest>(
    (o) => new QueryAutocompletionRequest.created(o));

/// codec for QueryAutocompletePrediction
final __codec197 = new JsInterfaceCodec<QueryAutocompletePrediction>(
    (o) => new QueryAutocompletePrediction.created(o));

/// codec for List<QueryAutocompletePrediction>
final __codec198 = new JsListCodec<QueryAutocompletePrediction>(__codec197);
...
final __codec199 =
    new FunctionCodec /*<(List<QueryAutocompletePrediction>, PlacesServiceStatus) → dynamic>*/ (
        (f) => (p_p1, p_p2) {
  p_p1 = __codec198.decode(p_p1);
  p_p2 = __codec194.decode(p_p2);
  return f(p_p1, p_p2);
}, (JsFunction f) => (p_p1, p_p2) {
  p_p1 = __codec198.encode(p_p1);
  p_p2 = __codec194.encode(p_p2);
  return f.apply([p_p1, p_p2]);
});
...
class AutocompletionRequest extends JsInterface
  ...
  void set location(LatLng _location) {
    asJsObject(this)['location'] = __codec200.encode(_location);
  }
  LatLng get location => __codec200.decode(asJsObject(this)['location']);
  void set offset(num _offset) {
    asJsObject(this)['offset'] = _offset;
  }
  num get offset => asJsObject(this)['offset'];
...
/// codec for LatLng
final __codec200 = new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o));
...
class PlacePhoto extends JsInterface implements _PlacePhoto {
  ...
  String getUrl(PhotoOptions opts) =>
      asJsObject(this).callMethod('getUrl', [__codec201.encode(opts)]);
...
class PlaceResult extends JsInterface implements _PlaceResult {
  ...
  void set _address_components(
    ...
    asJsObject(this)['address_components'] =
        __codec203.encode(__address_components);
  }
  List<GeocoderAddressComponent> get _address_components =>
      __codec203.decode(asJsObject(this)['address_components']);
  ...
  void set aspects(List<PlaceAspectRating> _aspects) {
    asJsObject(this)['aspects'] = __codec205.encode(_aspects);
  }
  List<PlaceAspectRating> get aspects =>
      __codec205.decode(asJsObject(this)['aspects']);
  ...
  void set geometry(PlaceGeometry _geometry) {
    asJsObject(this)['geometry'] = __codec206.encode(_geometry);
  }
  PlaceGeometry get geometry => __codec206.decode(asJsObject(this)['geometry']);
  void set _html_attributions(List<String> __html_attributions) {
    asJsObject(this)['html_attributions'] =
        __codec186.encode(__html_attributions);
  }
  ...
  void set photos(List<PlacePhoto> _photos) {
    asJsObject(this)['photos'] = __codec208.encode(_photos);
  }
  List<PlacePhoto> get photos => __codec208.decode(asJsObject(this)['photos']);
  void set _place_id(String __place_id) {
    asJsObject(this)['place_id'] = __place_id;
  }
  String get _place_id => asJsObject(this)['place_id'];
  ...
  void set reviews(List<PlaceReview> _reviews) {
    asJsObject(this)['reviews'] = __codec210.encode(_reviews);
  }
  List<PlaceReview> get reviews =>
      __codec210.decode(asJsObject(this)['reviews']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec186.encode(_types);
  }
  List<String> get types => __codec186.decode(asJsObject(this)['types']);
...
final __codec202 = new JsInterfaceCodec<GeocoderAddressComponent>(
    (o) => new GeocoderAddressComponent.created(o));

/// codec for List<GeocoderAddressComponent>
final __codec203 = new JsListCodec<GeocoderAddressComponent>(__codec202);

/// codec for PlaceAspectRating
final __codec204 = new JsInterfaceCodec<PlaceAspectRating>(
    (o) => new PlaceAspectRating.created(o));

/// codec for List<PlaceAspectRating>
final __codec205 = new JsListCodec<PlaceAspectRating>(__codec204);
...
final __codec208 = new JsListCodec<PlacePhoto>(__codec207);
...
final __codec210 = new JsListCodec<PlaceReview>(__codec209);
...
class PlaceSearchRequest extends JsInterface implements _PlaceSearchRequest {
  ...
  void set rankBy(RankBy _rankBy) {
    asJsObject(this)['rankBy'] = __codec211.encode(_rankBy);
  }
  RankBy get rankBy => __codec211.decode(asJsObject(this)['rankBy']);
  void set types(List<String> _types) {
    asJsObject(this)['types'] = __codec186.encode(_types);
  }
  List<String> get types => __codec186.decode(asJsObject(this)['types']);
...
/// codec for RankBy
final __codec211 = new BiMapCodec<RankBy, dynamic>({
...
final __codec212 = new JsInterfaceCodec<PlaceDetailsRequest>(
...
final __codec214 = new JsInterfaceCodec<PlaceSearchRequest>(
    (o) => new PlaceSearchRequest.created(o));

/// codec for List<PlaceResult>
final __codec215 = new JsListCodec<PlaceResult>(__codec184);

/// codec for PlaceSearchPagination
final __codec216 = new JsInterfaceCodec<PlaceSearchPagination>(
...
final __codec217 =
    new FunctionCodec /*<(List<PlaceResult>, PlacesServiceStatus, PlaceSearchPagination) → dynamic>*/ (
        (f) => (p_p1, p_p2, p_p3) {
  p_p1 = __codec215.decode(p_p1);
  p_p2 = __codec194.decode(p_p2);
  p_p3 = __codec216.decode(p_p3);
  return f(p_p1, p_p2, p_p3);
}, (JsFunction f) => (p_p1, p_p2, p_p3) {
  p_p1 = __codec215.encode(p_p1);
  p_p2 = __codec194.encode(p_p2);
  p_p3 = __codec216.encode(p_p3);
  return f.apply([p_p1, p_p2, p_p3]);
});

/// codec for RadarSearchRequest
final __codec218 = new JsInterfaceCodec<RadarSearchRequest>(
...
final __codec220 = new JsInterfaceCodec<TextSearchRequest>(
...
class SearchBox extends MVCObject implements _SearchBox {
  ...
  List<PlaceResult> _getPlaces() =>
      __codec215.decode(asJsObject(this).callMethod('getPlaces'));
  void set bounds(LatLngBounds bounds) => _setBounds(bounds);
  void _setBounds(LatLngBounds bounds) {
    asJsObject(this).callMethod('setBounds', [__codec183.encode(bounds)]);
  }
...
final __codec221 = new JsInterfaceCodec<SearchBoxOptions>(
