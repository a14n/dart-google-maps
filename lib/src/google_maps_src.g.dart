...
class Data extends JsInterface {
  ...
  _add(dynamic /*DataFeature|DataFeatureOptions*/ feature) => __codec9
  ...
  dynamic /*DataStylingFunction|DataStyleOptions*/ get style =>
      (new ChainedCodec()
          ...
          .decode(_getStyle());
  _getStyle() => __codec9.decode(asJsObject(this).callMethod('getStyle'));
...
class DataFeature extends JsInterface {
  ...
  dynamic /*DataGeometryCollection|DataMultiPolygon|DataPolygon|DataLinearRing|DataMultiLineString|DataLineString|DataMultiPoint|DataPoint*/ get geometry => (new ChainedCodec()
      ...
      .decode(_getGeometry());
  _getGeometry() => __codec9.decode(asJsObject(this).callMethod('getGeometry'));
...
class DataGeometryCollection extends DataGeometry {
  ...
  _getArray() => __codec9.decode(asJsObject(this).callMethod('getArray'));
  ...
  dynamic /*DataGeometryCollection|DataMultiPolygon|DataPolygon|DataLinearRing|DataMultiLineString|DataLineString|DataMultiPoint|DataPoint*/ getAt(
      ...
      (new ChainedCodec()
            ...
            ..add(new JsInterfaceCodec<DataPoint>((o) => new DataPoint.created(o), (o) => o != null && o.instanceof(context['google']['maps']['Data']['Point'] as JsFunction))))
          .decode(_getAt(n));
  _getAt(num n) => __codec9.decode(asJsObject(this).callMethod('getAt', [n]));
...
class ImageMapType extends MVCObject implements MapType {
  ...
  Node getTile(Point tileCoord, num zoom, Document ownerDocument) =>
      asJsObject(this).callMethod(
          'getTile', [__codec2.encode(tileCoord), zoom, ownerDocument]);
...
class ImageMapTypeOptions extends JsInterface {
  ...
  void set getTileUrl(dynamic _getTileUrl) {
    asJsObject(this)['getTileUrl'] = __codec9.encode(_getTileUrl);
  }

  dynamic get getTileUrl => __codec9.decode(asJsObject(this)['getTileUrl']);
  void set maxZoom(num _maxZoom) {
    asJsObject(this)['maxZoom'] = _maxZoom;
  }
...
class MapTypeRegistry extends MVCObject {
  ...
  void set(String id, covariant MapType mapType) {
    asJsObject(this).callMethod('set', [id, __codec65.encode(mapType)]);
  }
}
...
class MapTypeStyle extends JsInterface {
  ...
  void set elementType(MapTypeStyleElementType _elementType) {
    asJsObject(this)['elementType'] = __codec66.encode(_elementType);
  }

  MapTypeStyleElementType get elementType =>
      __codec66.decode(asJsObject(this)['elementType']);
  void set featureType(MapTypeStyleFeatureType _featureType) {
    asJsObject(this)['featureType'] = __codec67.encode(_featureType);
  }

  MapTypeStyleFeatureType get featureType =>
      __codec67.decode(asJsObject(this)['featureType']);
  void set stylers(List<MapTypeStyler> _stylers) {
    asJsObject(this)['stylers'] = __codec69.encode(_stylers);
  }

  List<MapTypeStyler> get stylers =>
      __codec69.decode(asJsObject(this)['stylers']);
}
...
class Projection extends JsInterface {
  ...
  Point fromLatLngToPoint(LatLng latLng, [Point point]) =>
      __codec2.decode(asJsObject(this).callMethod('fromLatLngToPoint',
          [__codec0.encode(latLng), __codec2.encode(point)]));
  LatLng fromPointToLatLng(Point pixel, [bool nowrap]) =>
      __codec0.decode(asJsObject(this)
          .callMethod('fromPointToLatLng', [__codec2.encode(pixel), nowrap]));
}
...
class StyledMapType extends MVCObject implements MapType {
  ...
  StyledMapType(List<MapTypeStyle> styles, [StyledMapTypeOptions options])
      : this.created(new JsObject(context['google']['maps']['StyledMapType'],
            [__codec62.encode(styles), __codec70.encode(options)]));
...
class MVCArray<E> extends MVCObject {
  ...
  void _forEach(void callback(o, num index)) {
    asJsObject(this).callMethod('forEach', [__codec71.encode(callback)]);
  }

  List<E> getArray() => new JsList.created(_getArray() as JsArray, _codec);
  _getArray() => __codec9.decode(asJsObject(this).callMethod('getArray'));
  E getAt(num i) => _codec.decode(_getAt(i));
  _getAt(num i) => __codec9.decode(asJsObject(this).callMethod('getAt', [i]));
  num get length => _getLength();
  num _getLength() => asJsObject(this).callMethod('getLength');
  ...
  _pop() => __codec9.decode(asJsObject(this).callMethod('pop'));
...
class MVCObject extends JsInterface {
  ...
  void bindTo(String key, MVCObject target, [String targetKey, bool noNotify]) {
    asJsObject(this).callMethod(
        'bindTo', [key, __codec72.encode(target), targetKey, noNotify]);
  }
...
class Circle extends MVCObject {
  ...
  Circle([CircleOptions opts])
      : this.created(new JsObject(
            context['google']['maps']['Circle'], [__codec73.encode(opts)]));
...
class CircleOptions extends JsInterface {
  ...
  void set strokePosition(StrokePosition _strokePosition) {
    asJsObject(this)['strokePosition'] = __codec74.encode(_strokePosition);
  }

  StrokePosition get strokePosition =>
      __codec74.decode(asJsObject(this)['strokePosition']);
  void set strokeWeight(num _strokeWeight) {
    asJsObject(this)['strokeWeight'] = _strokeWeight;
  }
...
class GroundOverlay extends MVCObject {
  ...
  GroundOverlay(String url, LatLngBounds bounds, [GroundOverlayOptions opts])
      : this.created(new JsObject(context['google']['maps']['GroundOverlay'],
            [url, __codec1.encode(bounds), __codec75.encode(opts)]));
...
class IconSequence extends JsInterface {
  ...
  void set icon(GSymbol _icon) {
    asJsObject(this)['icon'] = __codec76.encode(_icon);
  }

  GSymbol get icon => __codec76.decode(asJsObject(this)['icon']);
...
class InfoWindow extends MVCObject {
  ...
  InfoWindow([InfoWindowOptions opts])
      : this.created(new JsObject(
            context['google']['maps']['InfoWindow'], [__codec77.encode(opts)]));
  ...
  _open([dynamic /*GMap|StreetViewPanorama*/ map, MVCObject anchor]) =>
      __codec9.decode(asJsObject(this).callMethod(
          'open', [__codec9.encode(map), __codec72.encode(anchor)]));
...
class Marker extends MVCObject {
  ...
  Marker([MarkerOptions opts])
      : this.created(new JsObject(
            context['google']['maps']['Marker'], [__codec78.encode(opts)]));

  Animation get animation => _getAnimation();
  Animation _getAnimation() =>
      __codec79.decode(asJsObject(this).callMethod('getAnimation'));
  Attribution get attribution => _getAttribution();
  Attribution _getAttribution() =>
      __codec80.decode(asJsObject(this).callMethod('getAttribution'));
  ...
  dynamic /*String|Icon|GSymbol*/ get icon => (new ChainedCodec()
        ...
        ..add(new JsInterfaceCodec<GSymbol>((o) => new GSymbol.created(o))))
      .decode(_getIcon());
  _getIcon() => __codec9.decode(asJsObject(this).callMethod('getIcon'));
  MarkerLabel get label => _getLabel();
  MarkerLabel _getLabel() =>
      __codec81.decode(asJsObject(this).callMethod('getLabel'));
        ...
        ..add(new JsInterfaceCodec<StreetViewPanorama>(
            ...
            (o) =>
                ...
                o.instanceof(context['google']['maps']['StreetViewPanorama']
                    as JsFunction))))
      .decode(_getMap());
  _getMap() => __codec9.decode(asJsObject(this).callMethod('getMap'));
  num get opacity => _getOpacity();
  num _getOpacity() => asJsObject(this).callMethod('getOpacity');
  MarkerPlace get place => _getPlace();
  MarkerPlace _getPlace() =>
      __codec82.decode(asJsObject(this).callMethod('getPlace'));
  LatLng get position => _getPosition();
  LatLng _getPosition() =>
      __codec0.decode(asJsObject(this).callMethod('getPosition'));
  ...
  void _setAnimation(Animation animation) {
    asJsObject(this).callMethod('setAnimation', [__codec79.encode(animation)]);
  }

  void set attribution(Attribution attribution) => _setAttribution(attribution);
  void _setAttribution(Attribution attribution) {
    asJsObject(this)
        .callMethod('setAttribution', [__codec80.encode(attribution)]);
  }
  ...
  void _setOptions(MarkerOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec78.encode(options)]);
  }

  void set place(MarkerPlace place) => _setPlace(place);
  void _setPlace(MarkerPlace place) {
    asJsObject(this).callMethod('setPlace', [__codec82.encode(place)]);
  }
...
class MarkerOptions extends JsInterface {
  ...
  void set animation(Animation _animation) {
    asJsObject(this)['animation'] = __codec79.encode(_animation);
  }

  Animation get animation => __codec79.decode(asJsObject(this)['animation']);
  void set attribution(Attribution _attribution) {
    asJsObject(this)['attribution'] = __codec80.encode(_attribution);
  }

  Attribution get attribution =>
      __codec80.decode(asJsObject(this)['attribution']);
  void set clickable(bool _clickable) {
    asJsObject(this)['clickable'] = _clickable;
  }
  ...
  void set place(MarkerPlace _place) {
    asJsObject(this)['place'] = __codec82.encode(_place);
  }

  MarkerPlace get place => __codec82.decode(asJsObject(this)['place']);
  void set position(LatLng _position) {
    asJsObject(this)['position'] = __codec0.encode(_position);
  }
...
class MarkerShape extends JsInterface {
  ...
  void set coords(List<num> _coords) {
    asJsObject(this)['coords'] = __codec83.encode(_coords);
  }

  List<num> get coords => __codec83.decode(asJsObject(this)['coords']);
...
class OverlayView extends JsInterface {
  ...
  MapPanes _getPanes() =>
      __codec84.decode(asJsObject(this).callMethod('getPanes'));
  MapCanvasProjection get projection => _getProjection();
  MapCanvasProjection _getProjection() =>
      __codec85.decode(asJsObject(this).callMethod('getProjection'));
  void onAdd() {
...
class Polygon extends MVCObject {
  ...
  Polygon([PolygonOptions opts])
      : this.created(new JsObject(
            context['google']['maps']['Polygon'], [__codec86.encode(opts)]));
  ...
  _getPath() => __codec9.decode(asJsObject(this).callMethod('getPath'));
  ...
  _getPaths() => __codec9.decode(asJsObject(this).callMethod('getPaths'));
  bool get visible => _getVisible();
  bool _getVisible() => asJsObject(this).callMethod('getVisible');
  void set draggable(bool draggable) => _setDraggable(draggable);
  void _setDraggable(bool draggable) {
  ...
  void _setOptions(PolygonOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec86.encode(options)]);
  }
...
class PolygonOptions extends JsInterface {
  ...
  dynamic /*MVCArray<MVCArray<LatLng>>|MVCArray<LatLng>|List<List<LatLng>>|List<LatLng>*/ get paths => (new ChainedCodec()
        ..add(new JsInterfaceCodec<MVCArray<MVCArray<LatLng>>>((o) =>
            new MVCArray<MVCArray<LatLng>>.created(
                o,
        ...
        ..add(new JsInterfaceCodec<MVCArray<LatLng>>((o) => new MVCArray<LatLng>.created(
            o, new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o), (o) => o != null && o.instanceof(context['google']['maps']['LatLng'] as JsFunction)))))
        ..add(new JsListCodec<List<LatLng>>(new JsListCodec<LatLng>(new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o), (o) => o != null && o.instanceof(context['google']['maps']['LatLng'] as JsFunction)))))
        ..add(new JsListCodec<LatLng>(new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o), (o) => o != null && o.instanceof(context['google']['maps']['LatLng'] as JsFunction)))))
      .decode(_paths);
  void set paths(
...
class Polyline extends MVCObject {
  ...
  Polyline([PolylineOptions opts])
      : this.created(new JsObject(
            context['google']['maps']['Polyline'], [__codec87.encode(opts)]));
  ...
  void _setOptions(PolylineOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec87.encode(options)]);
  }
...
class PolylineOptions extends JsInterface {
  ...
  void set icons(List<IconSequence> _icons) {
    asJsObject(this)['icons'] = __codec89.encode(_icons);
  }

  List<IconSequence> get icons => __codec89.decode(asJsObject(this)['icons']);
  void set map(GMap _map) {
    asJsObject(this)['map'] = __codec16.encode(_map);
  }
...
class Rectangle extends MVCObject {
  ...
  Rectangle([RectangleOptions opts])
      : this.created(new JsObject(
            context['google']['maps']['Rectangle'], [__codec90.encode(opts)]));
  ...
  void _setOptions(RectangleOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec90.encode(options)]);
  }
...
class SaveWidget extends MVCObject {
  ...
  SaveWidget(Node container, [SaveWidgetOptions opts])
      : this.created(new JsObject(context['google']['maps']['SaveWidget'],
            [container, __codec91.encode(opts)]));
  ...
  void _setOptions(SaveWidgetOptions opts) {
    asJsObject(this).callMethod('setOptions', [__codec91.encode(opts)]);
  }
...
class DirectionsRenderer extends MVCObject {
  ...
  DirectionsRenderer([DirectionsRendererOptions opts])
      : this.created(new JsObject(
            ...
            [__codec97.encode(opts)]));

  DirectionsResult get directions => _getDirections();
  DirectionsResult _getDirections() =>
      __codec98.decode(asJsObject(this).callMethod('getDirections'));
  GMap get map => _getMap();
  GMap _getMap() => __codec16.decode(asJsObject(this).callMethod('getMap'));
  ...
  void _setDirections(DirectionsResult directions) {
    asJsObject(this)
        .callMethod('setDirections', [__codec98.encode(directions)]);
  }
  ...
  void _setOptions(DirectionsRendererOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec97.encode(options)]);
  }
...
class DirectionsRendererOptions extends JsInterface {
  ...
  void set directions(DirectionsResult _directions) {
    asJsObject(this)['directions'] = __codec98.encode(_directions);
  }

  DirectionsResult get directions =>
      __codec98.decode(asJsObject(this)['directions']);
  void set draggable(bool _draggable) {
    asJsObject(this)['draggable'] = _draggable;
  }
  ...
  void set infoWindow(InfoWindow _infoWindow) {
    asJsObject(this)['infoWindow'] = __codec99.encode(_infoWindow);
  }

  InfoWindow get infoWindow => __codec99.decode(asJsObject(this)['infoWindow']);
  void set map(GMap _map) {
    asJsObject(this)['map'] = __codec16.encode(_map);
  }
  ...
  void set markerOptions(MarkerOptions _markerOptions) {
    asJsObject(this)['markerOptions'] = __codec78.encode(_markerOptions);
  }

  MarkerOptions get markerOptions =>
      __codec78.decode(asJsObject(this)['markerOptions']);
  ...
  void set polylineOptions(PolylineOptions _polylineOptions) {
    asJsObject(this)['polylineOptions'] = __codec87.encode(_polylineOptions);
  }

  PolylineOptions get polylineOptions =>
      __codec87.decode(asJsObject(this)['polylineOptions']);
  void set preserveViewport(bool _preserveViewport) {
    asJsObject(this)['preserveViewport'] = _preserveViewport;
  }
...
class DirectionsRequest extends JsInterface {
  ...
  void set drivingOptions(DrivingOptions _drivingOptions) {
    asJsObject(this)['drivingOptions'] = __codec100.encode(_drivingOptions);
  }

  DrivingOptions get drivingOptions =>
      __codec100.decode(asJsObject(this)['drivingOptions']);
  ...
  void set transitOptions(TransitOptions _transitOptions) {
    asJsObject(this)['transitOptions'] = __codec101.encode(_transitOptions);
  }

  TransitOptions get transitOptions =>
      __codec101.decode(asJsObject(this)['transitOptions']);
  void set travelMode(TravelMode _travelMode) {
    asJsObject(this)['travelMode'] = __codec102.encode(_travelMode);
  }

  TravelMode get travelMode =>
      __codec102.decode(asJsObject(this)['travelMode']);
  void set unitSystem(UnitSystem _unitSystem) {
    asJsObject(this)['unitSystem'] = __codec103.encode(_unitSystem);
  }

  UnitSystem get unitSystem =>
      __codec103.decode(asJsObject(this)['unitSystem']);
  void set waypoints(List<DirectionsWaypoint> _waypoints) {
    asJsObject(this)['waypoints'] = __codec105.encode(_waypoints);
  }

  List<DirectionsWaypoint> get waypoints =>
      __codec105.decode(asJsObject(this)['waypoints']);
}
...
class DirectionsResult extends JsInterface {
  ...
  void set _geocoded_waypoints(
    ...
    asJsObject(this)['geocoded_waypoints'] =
        __codec107.encode(__geocoded_waypoints);
  }

  List<DirectionsGeocodedWaypoint> get _geocoded_waypoints =>
      __codec107.decode(asJsObject(this)['geocoded_waypoints']);
  ...
  void set routes(List<DirectionsRoute> _routes) {
    asJsObject(this)['routes'] = __codec109.encode(_routes);
  }

  List<DirectionsRoute> get routes =>
      __codec109.decode(asJsObject(this)['routes']);
}
...
class DirectionsRoute extends JsInterface {
  ...
  void set fare(TransitFare _fare) {
    asJsObject(this)['fare'] = __codec110.encode(_fare);
  }

  TransitFare get fare => __codec110.decode(asJsObject(this)['fare']);
  void set legs(List<DirectionsLeg> _legs) {
    asJsObject(this)['legs'] = __codec112.encode(_legs);
  }

  List<DirectionsLeg> get legs => __codec112.decode(asJsObject(this)['legs']);
  ...
  void set _waypoint_order(List<num> __waypoint_order) {
    asJsObject(this)['waypoint_order'] = __codec83.encode(__waypoint_order);
  }

  List<num> get _waypoint_order =>
      __codec83.decode(asJsObject(this)['waypoint_order']);
...
class DirectionsService extends JsInterface {
  ...
  void route(DirectionsRequest request,
    ...
    asJsObject(this).callMethod(
        'route', [__codec113.encode(request), __codec115.encode(callback)]);
  }
}
...
class DirectionsStep extends JsInterface {
  ...
  void set transit(TransitDetails _transit) {
    asJsObject(this)['transit'] = __codec116.encode(_transit);
  }

  TransitDetails get transit => __codec116.decode(asJsObject(this)['transit']);
  void set _travel_mode(TravelMode __travel_mode) {
    asJsObject(this)['travel_mode'] = __codec102.encode(__travel_mode);
  }

  TravelMode get _travel_mode =>
      __codec102.decode(asJsObject(this)['travel_mode']);
...
class DistanceMatrixResponseElement extends JsInterface {
  ...
  void set status(DistanceMatrixElementStatus _status) {
    asJsObject(this)['status'] = __codec119.encode(_status);
  }

  DistanceMatrixElementStatus get status =>
      __codec119.decode(asJsObject(this)['status']);
}
...
class DistanceMatrixService extends JsInterface {
  ...
  void getDistanceMatrix(DistanceMatrixRequest request,
    ...
    asJsObject(this).callMethod('getDistanceMatrix',
        [__codec122.encode(request), __codec125.encode(callback)]);
  }
}
...
class DrivingOptions extends JsInterface {
  ...
  void set trafficModel(TrafficModel _trafficModel) {
    asJsObject(this)['trafficModel'] = __codec126.encode(_trafficModel);
  }

  TrafficModel get trafficModel =>
      __codec126.decode(asJsObject(this)['trafficModel']);
}
...
class Geocoder extends JsInterface {
  ...
  void geocode(GeocoderRequest request,
    ...
    asJsObject(this).callMethod(
        'geocode', [__codec133.encode(request), __codec137.encode(callback)]);
  }
}
...
class GeocoderGeometry extends JsInterface {
  ...
  void set _location_type(GeocoderLocationType __location_type) {
    asJsObject(this)['location_type'] = __codec138.encode(__location_type);
  }

  GeocoderLocationType get _location_type =>
      __codec138.decode(asJsObject(this)['location_type']);
...
class GeocoderRequest extends JsInterface {
  ...
  void set componentRestrictions(
    ...
    asJsObject(this)['componentRestrictions'] =
        __codec139.encode(_componentRestrictions);
  }

  GeocoderComponentRestrictions get componentRestrictions =>
      __codec139.decode(asJsObject(this)['componentRestrictions']);
  void set location(LatLng _location) {
    asJsObject(this)['location'] = __codec0.encode(_location);
  }
...
class GeocoderResult extends JsInterface {
  ...
  void set _address_components(
    ...
    asJsObject(this)['address_components'] =
        __codec141.encode(__address_components);
  }

  List<GeocoderAddressComponent> get _address_components =>
      __codec141.decode(asJsObject(this)['address_components']);
  ...
  void set geometry(GeocoderGeometry _geometry) {
    asJsObject(this)['geometry'] = __codec142.encode(_geometry);
  }

  GeocoderGeometry get geometry =>
      __codec142.decode(asJsObject(this)['geometry']);
  void set _partial_match(bool __partial_match) {
    asJsObject(this)['partial_match'] = __partial_match;
  }
...
class MaxZoomResult extends JsInterface {
  ...
  void set status(MaxZoomStatus _status) {
    asJsObject(this)['status'] = __codec143.encode(_status);
  }

  MaxZoomStatus get status => __codec143.decode(asJsObject(this)['status']);
  void set zoom(num _zoom) {
    asJsObject(this)['zoom'] = _zoom;
  }
...
class MaxZoomService extends JsInterface {
  ...
  void getMaxZoomAtLatLng(LatLng latlng, callback(MaxZoomResult p1)) {
    asJsObject(this).callMethod('getMaxZoomAtLatLng',
        [__codec0.encode(latlng), __codec145.encode(callback)]);
  }
}
...
class TransitDetails extends JsInterface {
  ...
  void set _arrival_stop(TransitStop __arrival_stop) {
    asJsObject(this)['arrival_stop'] = __codec146.encode(__arrival_stop);
  }

  TransitStop get _arrival_stop =>
      __codec146.decode(asJsObject(this)['arrival_stop']);
  ...
  void set _departure_stop(TransitStop __departure_stop) {
    asJsObject(this)['departure_stop'] = __codec146.encode(__departure_stop);
  }

  TransitStop get _departure_stop =>
      __codec146.decode(asJsObject(this)['departure_stop']);
  ...
  void set line(TransitLine _line) {
    asJsObject(this)['line'] = __codec147.encode(_line);
  }

  TransitLine get line => __codec147.decode(asJsObject(this)['line']);
...
class TransitLine extends JsInterface {
  ...
  void set agencies(List<TransitAgency> _agencies) {
    asJsObject(this)['agencies'] = __codec149.encode(_agencies);
  }

  List<TransitAgency> get agencies =>
      __codec149.decode(asJsObject(this)['agencies']);
  void set color(String _color) {
    asJsObject(this)['color'] = _color;
  }
  ...
  void set vehicle(TransitVehicle _vehicle) {
    asJsObject(this)['vehicle'] = __codec150.encode(_vehicle);
  }

  TransitVehicle get vehicle => __codec150.decode(asJsObject(this)['vehicle']);
}
...
class TransitOptions extends JsInterface {
  ...
  void set modes(List<TransitMode> _modes) {
    asJsObject(this)['modes'] = __codec152.encode(_modes);
  }

  List<TransitMode> get modes => __codec152.decode(asJsObject(this)['modes']);
  void set routingPreference(TransitRoutePreference _routingPreference) {
    asJsObject(this)['routingPreference'] =
        __codec153.encode(_routingPreference);
  }

  TransitRoutePreference get routingPreference =>
      __codec153.decode(asJsObject(this)['routingPreference']);
}
...
class TransitVehicle extends JsInterface {
  ...
  void set type(VehicleType _type) {
    asJsObject(this)['type'] = __codec154.encode(_type);
  }

  VehicleType get type => __codec154.decode(asJsObject(this)['type']);
}
...
class StreetViewPanorama extends MVCObject {
  ...
  StreetViewPov _getPhotographerPov() =>
      __codec161.decode(asJsObject(this).callMethod('getPhotographerPov'));
  LatLng get position => _getPosition();
  LatLng _getPosition() =>
      __codec0.decode(asJsObject(this).callMethod('getPosition'));
  StreetViewPov get pov => _getPov();
  StreetViewPov _getPov() =>
      __codec161.decode(asJsObject(this).callMethod('getPov'));
  StreetViewStatus get status => _getStatus();
  StreetViewStatus _getStatus() =>
      __codec162.decode(asJsObject(this).callMethod('getStatus'));
  bool get visible => _getVisible();
  bool _getVisible() => asJsObject(this).callMethod('getVisible');
  ...
  void _setPov(StreetViewPov pov) {
    asJsObject(this).callMethod('setPov', [__codec161.encode(pov)]);
  }
...
class StreetViewPanoramaData extends JsInterface {
  ...
  void set links(List<StreetViewLink> _links) {
    asJsObject(this)['links'] = __codec159.encode(_links);
  }

  List<StreetViewLink> get links =>
      __codec159.decode(asJsObject(this)['links']);
  void set location(StreetViewLocation _location) {
    asJsObject(this)['location'] = __codec160.encode(_location);
  }

  StreetViewLocation get location =>
      __codec160.decode(asJsObject(this)['location']);
  void set tiles(StreetViewTileData _tiles) {
    asJsObject(this)['tiles'] = __codec164.encode(_tiles);
  }

  StreetViewTileData get tiles => __codec164.decode(asJsObject(this)['tiles']);
}
...
class StreetViewPanoramaOptions extends JsInterface {
  ...
  void set addressControlOptions(
    ...
    asJsObject(this)['addressControlOptions'] =
        __codec165.encode(_addressControlOptions);
  }

  StreetViewAddressControlOptions get addressControlOptions =>
      __codec165.decode(asJsObject(this)['addressControlOptions']);
  ...
  void set panoProvider(dynamic _panoProvider) {
    asJsObject(this)['panoProvider'] = __codec9.encode(_panoProvider);
  }

  dynamic get panoProvider => __codec9.decode(asJsObject(this)['panoProvider']);
  void set position(LatLng _position) {
    asJsObject(this)['position'] = __codec0.encode(_position);
  }
  ...
  void set pov(StreetViewPov _pov) {
    asJsObject(this)['pov'] = __codec161.encode(_pov);
  }

  StreetViewPov get pov => __codec161.decode(asJsObject(this)['pov']);
  void set scrollwheel(bool _scrollwheel) {
    asJsObject(this)['scrollwheel'] = _scrollwheel;
  }
...
class StreetViewService extends JsInterface {
  ...
  void getPanoramaById(
    ...
    asJsObject(this)
        .callMethod('getPanoramaById', [pano, __codec167.encode(callback)]);
  }
  ...
  void getPanoramaByLocation(LatLng latlng, num radius,
    ...
    asJsObject(this).callMethod('getPanoramaByLocation',
        [__codec0.encode(latlng), radius, __codec167.encode(callback)]);
  }
}
...
final __codec2 = new JsInterfaceCodec<Point>((o) => new Point.created(o));
...
final __codec13 = new JsListCodec<DataFeature>(__codec12);

/// codec for google_maps.src.(DataFeature) → dynamic
final __codec14 = new FunctionCodec<Function> /*<(DataFeature) → dynamic>*/(
  (f) => (p_p1) => __codec9.encode(f(__codec12.decode(p_p1))),
  (f) => (p_p1) => __codec9.decode(f is JsFunction
      ? f.apply([__codec12.encode(p_p1)])
      : Function.apply(f, [__codec12.encode(p_p1)])),
);

/// codec for dart.core.List<String>
final __codec15 = new JsListCodec<String>(null);

/// codec for google_maps.src.GMap
final __codec16 = new JsInterfaceCodec<GMap>((o) => new GMap.created(o));

/// codec for google_maps.src.(List<DataFeature>) → dynamic
final __codec17 =
    new FunctionCodec<Function> /*<(List<DataFeature>) → dynamic>*/(
  (f) => (p_p1) => __codec9.encode(f(__codec13.decode(p_p1))),
  (f) => (p_p1) => __codec9.decode(f is JsFunction
      ? f.apply([__codec13.encode(p_p1)])
      : Function.apply(f, [__codec13.encode(p_p1)])),
);

/// codec for google_maps.src.DataStyleOptions
final __codec18 = new JsInterfaceCodec<DataStyleOptions>(
    (o) => new DataStyleOptions.created(o));

/// codec for google_maps.src.(Object) → dynamic
final __codec19 = new FunctionCodec<Function> /*<(Object) → dynamic>*/(
  (f) => (p_p1) => __codec9.encode(f(__codec10.decode(p_p1))),
  (f) => (p_p1) => __codec9.decode(f is JsFunction
      ? f.apply([__codec10.encode(p_p1)])
      : Function.apply(f, [__codec10.encode(p_p1)])),
);

/// codec for google_maps.src.DataFeatureOptions
final __codec20 = new JsInterfaceCodec<DataFeatureOptions>(
    (o) => new DataFeatureOptions.created(o));

/// codec for google_maps.src.(dynamic, String) → dynamic
final __codec21 = new FunctionCodec<Function> /*<(dynamic, String) → dynamic>*/(
  (f) => (p_p1, p_p2) => __codec9.encode(f(__codec9.decode(p_p1), p_p2)),
  (f) => (p_p1, p_p2) => __codec9.decode(f is JsFunction
      ? f.apply([__codec9.encode(p_p1), p_p2])
      : Function.apply(f, [__codec9.encode(p_p1), p_p2])),
);

/// codec for dart.core.List<LatLng>
final __codec22 = new JsListCodec<LatLng>(__codec0);
...
final __codec24 = new JsListCodec<DataLineString>(__codec23);
...
final __codec26 = new JsListCodec<DataPolygon>(__codec25);
...
final __codec28 = new JsListCodec<DataLinearRing>(__codec27);
...
final __codec30 = new FunctionCodec<Function> /*<(dynamic) → dynamic>*/(
  (f) => (p_p1) => __codec9.encode(f(__codec9.decode(p_p1))),
  (f) => (p_p1) => __codec9.decode(f is JsFunction
...
final __codec31 = new JsInterfaceCodec<MapsEventListener>(
    (o) => new MapsEventListener.created(o));

/// codec for google_maps.src.([dynamic]) → dynamic
final __codec32 = new FunctionCodec<Function> /*<([dynamic]) → dynamic>*/(
  (f) => ([p_p1]) => __codec9.encode(f(__codec9.decode(p_p1))),
  (f) => ([p_p1]) => __codec9.decode(f is JsFunction
      ? f.apply([__codec9.encode(p_p1)])
      : Function.apply(f, [__codec9.encode(p_p1)])),
...
final __codec44 = new JsInterfaceCodec<KmlLayerOptions>(
    (o) => new KmlLayerOptions.created(o));

/// codec for google_maps.src.KmlLayerMetadata
final __codec45 = new JsInterfaceCodec<KmlLayerMetadata>(
    (o) => new KmlLayerMetadata.created(o));

/// codec for google_maps.src.KmlLayerStatus
final __codec46 = new BiMapCodec<KmlLayerStatus, dynamic>(
...
final __codec50 = new JsInterfaceCodec<Data>((o) => new Data.created(o));

/// codec for google_maps.src.MapTypeRegistry
final __codec51 = new JsInterfaceCodec<MapTypeRegistry>(
...
final __codec62 = new JsListCodec<MapTypeStyle>(__codec61);

/// codec for google_maps.src.ZoomControlOptions
final __codec63 = new JsInterfaceCodec<ZoomControlOptions>(
    (o) => new ZoomControlOptions.created(o));

/// codec for google_maps.src.ImageMapTypeOptions
final __codec64 = new JsInterfaceCodec<ImageMapTypeOptions>(
    (o) => new ImageMapTypeOptions.created(o));

/// codec for google_maps.src.MapType
final __codec65 = new JsInterfaceCodec<MapType>((o) => new MapType.created(o));

/// codec for google_maps.src.MapTypeStyleElementType
final __codec66 = new BiMapCodec<MapTypeStyleElementType, dynamic>(
...
final __codec67 = new BiMapCodec<MapTypeStyleFeatureType, dynamic>(
...
final __codec69 = new JsListCodec<MapTypeStyler>(__codec68);

/// codec for google_maps.src.StyledMapTypeOptions
final __codec70 = new JsInterfaceCodec<StyledMapTypeOptions>(
    (o) => new StyledMapTypeOptions.created(o));

/// codec for google_maps.src.(dynamic, num) → void
final __codec71 = new FunctionCodec<Function> /*<(dynamic, num) → void>*/(
  (f) => (p_o, p_index) {
        f(__codec9.decode(p_o), p_index);
      },
  (f) => (p_o, p_index) {
        f is JsFunction
            ? f.apply([__codec9.encode(p_o), p_index])
            : Function.apply(f, [__codec9.encode(p_o), p_index]);
      },
);
...
final __codec74 = new BiMapCodec<StrokePosition, dynamic>(
    new Map<StrokePosition, dynamic>.fromIterable(StrokePosition.values,
        value: asJs));

/// codec for google_maps.src.GroundOverlayOptions
final __codec75 = new JsInterfaceCodec<GroundOverlayOptions>(
    (o) => new GroundOverlayOptions.created(o));

/// codec for google_maps.src.GSymbol
final __codec76 = new JsInterfaceCodec<GSymbol>((o) => new GSymbol.created(o));

/// codec for google_maps.src.InfoWindowOptions
final __codec77 = new JsInterfaceCodec<InfoWindowOptions>(
...
final __codec79 = new BiMapCodec<Animation, dynamic>(
...
final __codec83 = new JsListCodec<num>(null);
...
final __codec85 = new JsInterfaceCodec<MapCanvasProjection>(
...
final __codec87 = new JsInterfaceCodec<PolylineOptions>(
...
final __codec89 = new JsListCodec<IconSequence>(__codec88);

/// codec for google_maps.src.RectangleOptions
final __codec90 = new JsInterfaceCodec<RectangleOptions>(
    (o) => new RectangleOptions.created(o));

/// codec for google_maps.src.SaveWidgetOptions
final __codec91 = new JsInterfaceCodec<SaveWidgetOptions>(
...
final __codec97 = new JsInterfaceCodec<DirectionsRendererOptions>(
    (o) => new DirectionsRendererOptions.created(o));

/// codec for google_maps.src.DirectionsResult
final __codec98 = new JsInterfaceCodec<DirectionsResult>(
...
final __codec112 = new JsListCodec<DirectionsLeg>(__codec111);

/// codec for google_maps.src.DirectionsRequest
final __codec113 = new JsInterfaceCodec<DirectionsRequest>(
    (o) => new DirectionsRequest.created(o));

/// codec for google_maps.src.DirectionsStatus
final __codec114 = new BiMapCodec<DirectionsStatus, dynamic>(
...
final __codec115 = new FunctionCodec<
    Function> /*<(DirectionsResult, DirectionsStatus) → dynamic>*/(
  (f) => (p_p1, p_p2) =>
      __codec9.encode(f(__codec98.decode(p_p1), __codec114.decode(p_p2))),
  (f) => (p_p1, p_p2) => __codec9.decode(f is JsFunction
      ? f.apply([__codec98.encode(p_p1), __codec114.encode(p_p2)])
      : Function.apply(f, [__codec98.encode(p_p1), __codec114.encode(p_p2)])),
);
...
final __codec119 = new BiMapCodec<DistanceMatrixElementStatus, dynamic>(
...
final __codec122 = new JsInterfaceCodec<DistanceMatrixRequest>(
    (o) => new DistanceMatrixRequest.created(o));

/// codec for google_maps.src.DistanceMatrixResponse
final __codec123 = new JsInterfaceCodec<DistanceMatrixResponse>(
    (o) => new DistanceMatrixResponse.created(o));

/// codec for google_maps.src.DistanceMatrixStatus
final __codec124 = new BiMapCodec<DistanceMatrixStatus, dynamic>(
...
final __codec125 = new FunctionCodec<
    Function> /*<(DistanceMatrixResponse, DistanceMatrixStatus) → dynamic>*/(
  (f) => (p_p1, p_p2) =>
      __codec9.encode(f(__codec123.decode(p_p1), __codec124.decode(p_p2))),
  (f) => (p_p1, p_p2) => __codec9.decode(f is JsFunction
      ? f.apply([__codec123.encode(p_p1), __codec124.encode(p_p2)])
      : Function.apply(f, [__codec123.encode(p_p1), __codec124.encode(p_p2)])),
);

/// codec for google_maps.src.TrafficModel
final __codec126 = new BiMapCodec<TrafficModel, dynamic>(
    new Map<TrafficModel, dynamic>.fromIterable(TrafficModel.values,
        value: asJs));

/// codec for google_maps.src.PathElevationRequest
final __codec127 = new JsInterfaceCodec<PathElevationRequest>(
    (o) => new PathElevationRequest.created(o));

/// codec for google_maps.src.ElevationResult
final __codec128 = new JsInterfaceCodec<ElevationResult>(
    (o) => new ElevationResult.created(o));

/// codec for dart.core.List<ElevationResult>
final __codec129 = new JsListCodec<ElevationResult>(__codec128);

/// codec for google_maps.src.ElevationStatus
final __codec130 = new BiMapCodec<ElevationStatus, dynamic>(
...
final __codec131 = new FunctionCodec<
    Function> /*<(List<ElevationResult>, ElevationStatus) → dynamic>*/(
  (f) => (p_p1, p_p2) =>
      __codec9.encode(f(__codec129.decode(p_p1), __codec130.decode(p_p2))),
  (f) => (p_p1, p_p2) => __codec9.decode(f is JsFunction
      ? f.apply([__codec129.encode(p_p1), __codec130.encode(p_p2)])
      : Function.apply(f, [__codec129.encode(p_p1), __codec130.encode(p_p2)])),
);

/// codec for google_maps.src.LocationElevationRequest
final __codec132 = new JsInterfaceCodec<LocationElevationRequest>(
    (o) => new LocationElevationRequest.created(o));

/// codec for google_maps.src.GeocoderRequest
final __codec133 = new JsInterfaceCodec<GeocoderRequest>(
...
final __codec135 = new JsListCodec<GeocoderResult>(__codec134);

/// codec for google_maps.src.GeocoderStatus
final __codec136 = new BiMapCodec<GeocoderStatus, dynamic>(
...
final __codec137 = new FunctionCodec<
    Function> /*<(List<GeocoderResult>, GeocoderStatus) → dynamic>*/(
  (f) => (p_p1, p_p2) =>
      __codec9.encode(f(__codec135.decode(p_p1), __codec136.decode(p_p2))),
  (f) => (p_p1, p_p2) => __codec9.decode(f is JsFunction
      ? f.apply([__codec135.encode(p_p1), __codec136.encode(p_p2)])
      : Function.apply(f, [__codec135.encode(p_p1), __codec136.encode(p_p2)])),
);

/// codec for google_maps.src.GeocoderLocationType
final __codec138 = new BiMapCodec<GeocoderLocationType, dynamic>(
...
final __codec139 = new JsInterfaceCodec<GeocoderComponentRestrictions>(
    (o) => new GeocoderComponentRestrictions.created(o));

/// codec for google_maps.src.GeocoderAddressComponent
final __codec140 = new JsInterfaceCodec<GeocoderAddressComponent>(
    (o) => new GeocoderAddressComponent.created(o));

/// codec for dart.core.List<GeocoderAddressComponent>
final __codec141 = new JsListCodec<GeocoderAddressComponent>(__codec140);

/// codec for google_maps.src.GeocoderGeometry
final __codec142 = new JsInterfaceCodec<GeocoderGeometry>(
    (o) => new GeocoderGeometry.created(o));

/// codec for google_maps.src.MaxZoomStatus
final __codec143 = new BiMapCodec<MaxZoomStatus, dynamic>(
...
final __codec145 = new FunctionCodec<Function> /*<(MaxZoomResult) → dynamic>*/(
  (f) => (p_p1) => __codec9.encode(f(__codec144.decode(p_p1))),
  (f) => (p_p1) => __codec9.decode(f is JsFunction
      ? f.apply([__codec144.encode(p_p1)])
      : Function.apply(f, [__codec144.encode(p_p1)])),
);
...
final __codec149 = new JsListCodec<TransitAgency>(__codec148);
...
final __codec157 = new JsInterfaceCodec<StreetViewPanoramaOptions>(
...
final __codec159 = new JsListCodec<StreetViewLink>(__codec158);

/// codec for google_maps.src.StreetViewLocation
final __codec160 = new JsInterfaceCodec<StreetViewLocation>(
