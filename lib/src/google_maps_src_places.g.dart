...
final __codec43 =
    new FunctionCodec/*<(List<PlaceResult>, PlacesServiceStatus, [dynamic]) → dynamic>*/(
        (f) => (p_p1, p_p2, [p__]) => __codec0.encode(f(__codec39.decode(p_p1),
            __codec21.decode(p_p2), __codec0.decode(p__))),
...
final __codec10 =
    new FunctionCodec/*<(List<dynamic>, dynamic, [dynamic]) → dynamic>*/(
        (f) => (p_p1, p_p2, [p__]) => __codec0.encode(f(__codec3.decode(p_p1),
            __codec0.decode(p_p2), __codec0.decode(p__))),
        (JsFunction f) => (p_p1, p_p2, [p__]) => __codec0.decode(f.apply([
...
final __codec9 =
    new FunctionCodec/*<(List<dynamic>, dynamic, dynamic) → dynamic>*/(
        (f) => (p_p1, p_p2, p_p3) => __codec0.encode(f(__codec3.decode(p_p1),
            __codec0.decode(p_p2), __codec0.decode(p_p3))),
        (JsFunction f) => (p_p1, p_p2, p_p3) => __codec0.decode(f.apply([
              __codec3.encode(p_p1),
              __codec0.encode(p_p2),
...
final __codec8 = new FunctionCodec/*<(dynamic, dynamic) → dynamic>*/(
    (f) => (p_p1, p_p2) =>
...
final __codec4 = new FunctionCodec/*<(List<dynamic>, dynamic) → dynamic>*/(
    (f) => (p_p1, p_p2) =>
