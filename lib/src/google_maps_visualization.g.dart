...
class MapsEngineLayer extends MVCObject implements _MapsEngineLayer {
  ...
  GMap _getMap() => __codec224.decode(asJsObject(this).callMethod('getMap'));
  ...
  MapsEngineLayerProperties _getProperties() =>
      __codec225.decode(asJsObject(this).callMethod('getProperties'));
  MapsEngineStatus get status => _getStatus();
  MapsEngineStatus _getStatus() =>
      __codec226.decode(asJsObject(this).callMethod('getStatus'));
  ...
  void _setMap(GMap map) {
    asJsObject(this).callMethod('setMap', [__codec224.encode(map)]);
  }
  ...
  void _setOptions(MapsEngineLayerOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec223.encode(options)]);
  }
...
final __codec223 = new JsInterfaceCodec<MapsEngineLayerOptions>(
    (o) => new MapsEngineLayerOptions.created(o));

/// codec for GMap
final __codec224 = new JsInterfaceCodec<GMap>((o) => new GMap.created(o));

/// codec for MapsEngineLayerProperties
final __codec225 = new JsInterfaceCodec<MapsEngineLayerProperties>(
    (o) => new MapsEngineLayerProperties.created(o));

/// codec for dynamic
final __codec226 = new DynamicCodec();
...
class MapsEngineLayerOptions extends JsInterface
  ...
  void set map(GMap _map) {
    asJsObject(this)['map'] = __codec224.encode(_map);
  }
  GMap get map => __codec224.decode(asJsObject(this)['map']);
...
class MapsEngineMouseEvent extends JsInterface
  ...
  void set latLng(LatLng _latLng) {
    asJsObject(this)['latLng'] = __codec227.encode(_latLng);
  }
  LatLng get latLng => __codec227.decode(asJsObject(this)['latLng']);
  void set pixelOffset(Size _pixelOffset) {
    asJsObject(this)['pixelOffset'] = __codec228.encode(_pixelOffset);
  }
  Size get pixelOffset => __codec228.decode(asJsObject(this)['pixelOffset']);
}
/// codec for LatLng
final __codec227 = new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o));

/// codec for Size
final __codec228 = new JsInterfaceCodec<Size>((o) => new Size.created(o));
...
class MapsEngineStatus extends JsEnum {
  ...
  MapsEngineStatus._(o) : super.created(o);
}
...
class DynamicMapsEngineLayer extends MVCObject
  ...
  DynamicMapsEngineLayer(DynamicMapsEngineLayerOptions options) : this.created(
          new JsObject(
              ...
              [__codec229.encode(options)]));

  FeatureStyle getFeatureStyle(String featureId) => __codec230
  ...
  void _setOptions(DynamicMapsEngineLayerOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec229.encode(options)]);
  }
...
final __codec229 = new JsInterfaceCodec<DynamicMapsEngineLayerOptions>(
...
class DynamicMapsEngineMouseEvent extends JsInterface
  ...
  void getDetails(callback(MapsEngineMouseEvent p1)) {
    asJsObject(this).callMethod('getDetails', [__codec232.encode(callback)]);
  }
...
final __codec231 = new JsInterfaceCodec<MapsEngineMouseEvent>(
    (o) => new MapsEngineMouseEvent.created(o));

/// codec for (MapsEngineMouseEvent) → dynamic
final __codec232 = new FunctionCodec /*<(MapsEngineMouseEvent) → dynamic>*/ (
    (f) => (p_p1) {
  p_p1 = __codec231.decode(p_p1);
  final result = f(p_p1);
  return __codec226.encode(result);
}, (JsFunction f) => (p_p1) {
  p_p1 = __codec231.encode(p_p1);
  final result = f.apply([p_p1]);
  return __codec226.decode(result);
});
...
class HeatmapLayer extends MVCObject implements _HeatmapLayer {
  ...
  _getData() => __codec226.decode(asJsObject(this).callMethod('getData'));
  GMap get map => _getMap();
  GMap _getMap() => __codec224.decode(asJsObject(this).callMethod('getMap'));
  void set data(
  ...
  void _setData(
      dynamic /*MVCArray<dynamic/*LatLng|WeightedLocation*/>|List<dynamic/*LatLng|WeightedLocation*/>*/ data) {
    asJsObject(this).callMethod('setData', [__codec226.encode(data)]);
  }
  void set map(GMap map) => _setMap(map);
  void _setMap(GMap map) {
    asJsObject(this).callMethod('setMap', [__codec224.encode(map)]);
...
final __codec233 = new JsInterfaceCodec<HeatmapLayerOptions>(
...
class HeatmapLayerOptions extends JsInterface implements _HeatmapLayerOptions {
  ...
  void set _data(dynamic __data) {
    asJsObject(this)['data'] = __codec226.encode(__data);
  }
  dynamic get _data => __codec226.decode(asJsObject(this)['data']);
  ...
  void set gradient(List<String> _gradient) {
    asJsObject(this)['gradient'] = __codec234.encode(_gradient);
  }
  List<String> get gradient => __codec234.decode(asJsObject(this)['gradient']);
  void set map(GMap _map) {
    asJsObject(this)['map'] = __codec224.encode(_map);
  }
  GMap get map => __codec224.decode(asJsObject(this)['map']);
...
final __codec234 = new JsListCodec<String>(null);
...
class WeightedLocation extends JsInterface implements _WeightedLocation {
  ...
  void set location(LatLng _location) {
    asJsObject(this)['location'] = __codec227.encode(_location);
  }
  LatLng get location => __codec227.decode(asJsObject(this)['location']);
