...
class MapsEngineLayer extends MVCObject implements _MapsEngineLayer {
  ...
  GMap _getMap() => __codec221.decode(asJsObject(this).callMethod('getMap'));
  ...
  MapsEngineLayerProperties _getProperties() =>
      __codec222.decode(asJsObject(this).callMethod('getProperties'));
  MapsEngineStatus get status => _getStatus();
  MapsEngineStatus _getStatus() =>
      __codec223.decode(asJsObject(this).callMethod('getStatus'));
  ...
  void _setMap(GMap map) {
    asJsObject(this).callMethod('setMap', [__codec221.encode(map)]);
  }
  ...
  void _setOptions(MapsEngineLayerOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec220.encode(options)]);
  }
...
final __codec220 = new JsInterfaceCodec<MapsEngineLayerOptions>(
    (o) => new MapsEngineLayerOptions.created(o));

/// codec for GMap
final __codec221 = new JsInterfaceCodec<GMap>((o) => new GMap.created(o));

/// codec for MapsEngineLayerProperties
final __codec222 = new JsInterfaceCodec<MapsEngineLayerProperties>(
    (o) => new MapsEngineLayerProperties.created(o));

/// codec for MapsEngineStatus
final __codec223 = new BiMapCodec<MapsEngineStatus, dynamic>({
...
class MapsEngineLayerOptions extends JsInterface
  ...
  void set map(GMap _map) {
    asJsObject(this)['map'] = __codec221.encode(_map);
  }
  GMap get map => __codec221.decode(asJsObject(this)['map']);
...
class MapsEngineMouseEvent extends JsInterface
  ...
  void set latLng(LatLng _latLng) {
    asJsObject(this)['latLng'] = __codec224.encode(_latLng);
  }
  LatLng get latLng => __codec224.decode(asJsObject(this)['latLng']);
  void set pixelOffset(Size _pixelOffset) {
    asJsObject(this)['pixelOffset'] = __codec225.encode(_pixelOffset);
  }
  Size get pixelOffset => __codec225.decode(asJsObject(this)['pixelOffset']);
}
/// codec for LatLng
final __codec224 = new JsInterfaceCodec<LatLng>((o) => new LatLng.created(o));

/// codec for Size
final __codec225 = new JsInterfaceCodec<Size>((o) => new Size.created(o));
...
class DynamicMapsEngineLayer extends MVCObject
  ...
  DynamicMapsEngineLayer(DynamicMapsEngineLayerOptions options) : this.created(
          new JsObject(
              ...
              [__codec226.encode(options)]));

  FeatureStyle getFeatureStyle(String featureId) => __codec227
  ...
  void _setOptions(DynamicMapsEngineLayerOptions options) {
    asJsObject(this).callMethod('setOptions', [__codec226.encode(options)]);
  }
...
final __codec226 = new JsInterfaceCodec<DynamicMapsEngineLayerOptions>(
...
class DynamicMapsEngineMouseEvent extends JsInterface
  ...
  void getDetails(callback(MapsEngineMouseEvent p1)) {
    asJsObject(this).callMethod('getDetails', [__codec229.encode(callback)]);
  }
...
final __codec228 = new JsInterfaceCodec<MapsEngineMouseEvent>(
    (o) => new MapsEngineMouseEvent.created(o));

/// codec for (MapsEngineMouseEvent) → dynamic
final __codec229 = new FunctionCodec /*<(MapsEngineMouseEvent) → dynamic>*/ (
    (f) => (p_p1) {
  p_p1 = __codec228.decode(p_p1);
  return f(p_p1);
}, (JsFunction f) => (p_p1) {
  p_p1 = __codec228.encode(p_p1);
  return f.apply([p_p1]);
});
...
final __codec230 = new JsInterfaceCodec<HeatmapLayerOptions>(
...
class HeatmapLayerOptions extends JsInterface implements _HeatmapLayerOptions {
  ...
  void set gradient(List<String> _gradient) {
    asJsObject(this)['gradient'] = __codec231.encode(_gradient);
  }
  List<String> get gradient => __codec231.decode(asJsObject(this)['gradient']);
  void set map(GMap _map) {
    asJsObject(this)['map'] = __codec221.encode(_map);
  }
  GMap get map => __codec221.decode(asJsObject(this)['map']);
...
final __codec231 = new JsListCodec<String>(null);
...
class WeightedLocation extends JsInterface implements _WeightedLocation {
  ...
  void set location(LatLng _location) {
    asJsObject(this)['location'] = __codec224.encode(_location);
  }
  LatLng get location => __codec224.decode(asJsObject(this)['location']);
